...
export default function ContactSection() {
  ...
  return (
    <section id="kontaktai" className="py-12 sm:py-16 md:py-20 px-4 bg-white">
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs sm:text-sm text-gray-500 mb-1">{t(info.labelKey)}</div>
                  {info.href ? (
                    <a
                      href={info.href}
                    ...
                    >
                      {info.value || (info.valueKey ? t(info.valueKey) : '')}
                    </a>
                  ) : (
